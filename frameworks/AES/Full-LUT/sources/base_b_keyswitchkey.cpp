...
BaseBKeySwitchKey::BaseBKeySwitchKey(const int n, const int t,
                                     const int basebit, const int b,
...
BaseBKeySwitchKey::~BaseBKeySwitchKey() { delete[] ks; }

/**
 * BaseBKeySwitchKey constructor function
 */

void init_BaseBKeySwitchKey(BaseBKeySwitchKey* obj, int n, int t, int basebit,
                            int b, const TLweParams* out_params) {
...
void free_BaseBKeySwitchKey(BaseBKeySwitchKey* ptr) { free(ptr); }

BaseBKeySwitchKey* new_BaseBKeySwitchKey(int n, int t, int basebit, int b,
                                         const TLweParams* out_params) {
