...
public:
  ...
  void decSboxFunc(Ctxt &c, vector<PolyType> encLinTran, Ctxt &encA,
                   const EncryptedArrayDerived<PA_GF2> &ea);

  void decSboxFunc2(Ctxt &c, vector<PolyType> encLinTran, Ctxt &encA,
                    const EncryptedArrayDerived<PA_GF2> &ea);

  void Linear_function(Ctxt &c, const EncryptedArrayDerived<PA_GF2> &ea);
  void decLinearFunc(vector<Ctxt> &eData, long begin,
                     const EncryptedArrayDerived<PA_GF2> &ea);
